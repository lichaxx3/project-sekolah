...
<body >
  <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo ">
    ...
    <div class="wrapper wrapper--w680 bg-dark">
      ...
      @endif
      <div class="kartu">
        <!-- <div class="card-heading">gausah di isi</div> -->
        <div class="card-body">
          ...
          <form method="POST" action="/register_proses_admin">
            ...
            @enderror
            <div class="p-t-20">
              <button class="btn btn--radius btn-warning" type="submit">Submit</button>
              <a href="/login_web" class="btn btn--radius btn-warning">Login Akun</a>
            </div>
            {{-- <div class="p-t-20">
