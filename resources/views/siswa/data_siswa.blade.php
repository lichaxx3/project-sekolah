        ...
        <div class="content-wrapper bg-dark">
            ...
            <div class="content-header bg-dark">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-warning">Data Pembagian Kelas</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header bg-dark border border-warning">
                                    <h3 class="card-title text-warning">Data Pembagian Kelas</h3>
                                </div>
                                <!-- /.card-header -->
