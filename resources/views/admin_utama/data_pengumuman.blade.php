        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-warning">Pengumuman</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#tambah_pengumuman">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title text-dark" id="exampleModalLabel">Hapus
                                                                    Data
                                                                    Pengumuman
                                                                </h5>
                                                                ...
                                                                <form action="/admin_utama/data_pengumuman_delete"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <p class="text-dark">Apakah kamu yakin ingin menghapus data
                                                                                ini?</i></b></p>
                                                                        </div>
                                                                    </div>
