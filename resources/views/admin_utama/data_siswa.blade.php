    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-warning">Data Formulir Siswa</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              ...
              <div class="card">
                ...
                <div class="card-body border border-warning">
                  <div class="table-responsive">
                    <table id="data-kelas" class="table table-bordered ">
                      <thead>
                        <tr>
                          <th>Nama Kelas</th>
                          <th>Jumlah Siswa</th>
                        ...
                        @foreach ($user_siswas as $user_siswa)
                          ...
                          <div class="modal fade" id="edit_kelas{{ $user_siswa->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title text-dark" id="exampleModalLabel">Atur Kelas
                                  </h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                ...
                                <div class="modal-body">
                                  <form action="atur_kelas" method="POST">
                                    ...
                                    <div class="form-group">
                                      <label for="exampleInputEmail1" class="text-dark">Pilih Kelas</label>
                                      <select class="form-control" name="kelas">
                                        <option value="X IPA 1">X MPLB 1</option>
                                        <option value="X IPA 1">X MPLB 2</option>
                                        <option value="X IPA 1">X MPLB 3</option>
                                        <option value="X IPA 1">X TKJ 1</option>
                                        <option value="X IPA 1">X TKJ 2</option>
                                        <option value="X IPA 1">X TKJ 3</option>
                                        <option value="X IPA 1">X HOTEL 1</option>
                                        <option value="X IPA 1">X HOTEL 2</option>
                                        <option value="X IPA 1">X HOTEL 3</option>
                                        <option value="X IPA 1">X PM 1</option>
                                        <option value="X IPA 1">X PM 2</option>
                                        <option value="X IPA 1">X PM 3</option>
                                      </select>
                                    </div>
                          ...
                          <div class="modal fade" id="edit_status{{ $user_siswa->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title text-dark" id="exampleModalLabel">Atur Status
                                    Data
                                  </h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                ...
                                <div class="modal-body">
                                  <form action="atur_status_data" method="POST">
                                    @csrf
                                    <div class="form-group">
                                      <label for="exampleInputEmail1" class="text-dark">Pilih Status
                                        Data</label>
