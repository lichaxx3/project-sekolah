      ...
      <div class="limiter">
        ...
        <form class="login100-form validate-form" action="/login_proses" method="POST">
          ...
          <div class="d-flex flex-wrap">
            <button class="btn btn-sm rounded-pill px-4 m-1">
              Login
            </button>
            <a href="/register_web" class="btn btn-sm rounded-pill m-1">
              Register Siswa
            </a>
            <a href="/register_web_admin" class="btn btn-sm rounded-pill m-1">
              Register Tata Usaha
            </a>
          </div>
